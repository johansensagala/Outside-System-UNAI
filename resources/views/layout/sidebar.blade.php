<nav class="sidebar">
  ...
  <div class="sidebar-body" style="background-color: #38343c;">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-controls="uiComponents">
        ...
        <div class="collapse" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">Button group</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">Collapse</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Dropdowns</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">List group</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Media object</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Modal</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Navs</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">Popvers</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Progress</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Scrollbar</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Scrollspy</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Spinners</a>
            </li>
            <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#advanced-ui" role="button" aria-controls="advanced-ui">
        ...
        <div class="collapse" id="advanced-ui">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">SortableJs</a>
            </li>
            <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#forms" role="button" aria-controls="forms">
        ...
        <div class="collapse" id="forms">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">Wizard</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#charts" role="button" aria-controls="charts">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#tables" role="button" aria-controls="tables">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#icons" role="button" aria-controls="icons">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#general" role="button" aria-controls="general">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#auth" role="button" aria-controls="auth">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#error" role="button" aria-controls="error">
